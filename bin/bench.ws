...
#    pcap_in -d enp0s25 -d any -P -> $data_orig
    ...
    wsproto_in  -r /var/packets.mpproto -r /var/packets.mpproto -r /var/packets.mpproto -r /var/packets.mpproto -r /var/packets.mpproto -r /var/packets.mpproto -r /var/packets.mpproto -r /var/packets.mpproto -> $data_orig
    wsproto_in  -r /var/packets.mpproto -r /var/packets.mpproto -r /var/packets.mpproto -r /var/packets.mpproto -r /var/packets.mpproto -r /var/packets.mpproto -r /var/packets.mpproto -r /var/packets.mpproto -> $data_orig
#    wsproto_in -r /var/packets.mpproto -> $data_orig
#    wsproto_in -r /var/packets.mpproto -r /var/packets.mpproto -r /var/packets.mpproto -r /var/packets.mpproto -> $data_orig
#    wsproto_in -r /var/packets.mpproto -r /var/packets.mpproto -r /var/packets.mpproto -r /var/packets.mpproto -> $data_orig
#    wsproto_in -r /var/packets.mpproto -r /var/packets.mpproto -r /var/packets.mpproto -r /var/packets.mpproto -> $data_orig
#    wsproto_in -r /var/packets.mpproto -r /var/packets.mpproto -r /var/packets.mpproto -r /var/packets.mpproto -> $data_orig
#    wsproto_in -r /var/packets.mpproto -r /var/packets.mpproto -r /var/packets.mpproto -r /var/packets.mpproto -> $data_orig
...
#    wsproto_in -r /var/packets.mpproto -r /var/packets.mpproto -r /var/packets.mpproto -r /var/packets.mpproto -> $data_orig
    ...
    $data_orig | flush -N -C 100000 -> $status_var
...
#    $exit |  print -VVT
    $exit | redisstream -M 20000   -P bench-stream
    $unpacked_stat | subtuple CHAIN INCR_STATS.DEVICE_TEMP INCR_STATS.BANDWIDTH INCR_STATS.EVENT_CNT INCR_STATS.EVENT_RATE TOTAL_STATS.BYTE_CNT INCR_STATS.HIT_CNT TOTAL_STATS.END_TS INCR_STATS.INTERVAL | redisstream -M 8192 -P status-stream
}
